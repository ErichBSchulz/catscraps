...
ax.barh(y_run1_pass1, run1_pass1, bar_width, label='Run 1 Pass 1', color='#a0cbe8', edgecolor='black')
ax.barh(y_run1_pass2, run1_pass2, bar_width, label='Run 1 Pass 2', color='#4e79a7', edgecolor='black')
ax.barh(y_run2_pass1, run2_pass1, bar_width, label='Run 2 Pass 1', color='#ffb366', edgecolor='black')
ax.barh(y_run2_pass2, run2_pass2, bar_width, label='Run 2 Pass 2', color='#ff8000', edgecolor='black')
